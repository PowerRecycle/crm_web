    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/findAllRoles2">角色管理</a></li>
                            ...
                            <c:forEach items="${roles}" var="role">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/findRoleDetailsById/${role.id}"
                                           class="btn bg-olive btn-xs">详情</a>
                                        <a href="${pageContext.request.contextPath}/deleteRole/${role.id}"
                                           class="btn bg-olive btn-xs">删除角色</a>
                                        <a href="${pageContext.request.contextPath}/findRoleByIdAndAllPermission/${role.id}"
